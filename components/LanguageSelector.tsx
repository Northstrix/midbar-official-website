...
const LANGUAGES = [
  ...
  { code: "tr", label: "Türkçe", applyText: "Uygula" },
];
        ...
        <ModalOverlay onClose={handleClose}>
          <motion.div
            ...
            onClick={(e) => e.stopPropagation()}
              className="relative rounded-lg shadow-xl p-4 md:p-6 min-w-[300px] max-w-[90vw] border flex flex-col items-center outline-none"            style={{
