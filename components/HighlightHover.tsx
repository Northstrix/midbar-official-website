...
interface HighlightHoverProps {
  ...
  defaultTextColor?: string; // Added optional prop
  barThickness?: number;
  gapRatio?: number;
...
export const HighlightHover = ({
  ...
  defaultTextColor = "var(--sub-foreground)", // Default value assigned here
  barThickness = 0.12,
  gapRatio = 0.03,
  maxWidth = "100%",
  noReact = false,
  ...
  const barAnim = {
    rest: {
      height: "var(--hh-bar)",
      backgroundColor: noReact ? "transparent" : defaultTextColor, // Updated
  ...
  const textAnim = {
    rest: {
      color: defaultTextColor, // Updated
      paddingLeft: "0px",
      paddingRight: "0px",
